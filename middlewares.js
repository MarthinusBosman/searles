...
// .svelte-kit/output/server/chunks/__layout-87e29705.js
var layout_87e29705_exports = {};
__export(layout_87e29705_exports, {
  default: () => _layout
});
...
var Component, LogLevel, levelStringToEnum, defaultLogLevel, ConsoleMethod, defaultLogHandler, Logger, PlatformLoggerServiceImpl, name$o, version$1, logger, name$n, name$m, name$l, name$k, name$j, name$i, name$h, name$g, name$f, name$e, name$d, name$c, name$b, name$a, name$9, name$8, name$7, name$6, name$5, name$4, name$3, name$2, name$1, name$p, PLATFORM_LOG_STRING, _apps, _components, name, version, _layout;
var init_layout_87e29705 = __esm({
  ".svelte-kit/output/server/chunks/__layout-87e29705.js"() {
    init_shims();
    init_app_fd18b859();
    Component = class {
...
// .svelte-kit/output/server/chunks/error-9773dc94.js
var error_9773dc94_exports = {};
__export(error_9773dc94_exports, {
  default: () => Error2,
  load: () => load
});
...
// .svelte-kit/output/server/chunks/index-9b9b6a46.js
var index_9b9b6a46_exports = {};
__export(index_9b9b6a46_exports, {
  default: () => Routes
});
var css, Routes;
var init_index_9b9b6a46 = __esm({
  ".svelte-kit/output/server/chunks/index-9b9b6a46.js"() {
    init_shims();
    init_app_fd18b859();
    css = {
      code: ".mi.svelte-1w5xhqn{vertical-align:middle}.u-sr-only.svelte-1w5xhqn{position:absolute;left:-10000px;top:auto;width:1px;height:1px;overflow:hidden}",
      map: null
    };
    Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      $$result.css.add(css);
      return `<div class="${"flex flex-col items-center justify-center h-screen bg-logoBlue"}"><img class="${"w-4/5 max-w-md"}" src="${"/images/logo.png"}" alt="${"Searles Logo"}">
	${showOpening ? `<h1 class="${"font-serif text-4xl text-center"}">Opening this Saturday!</h1>` : `<h1 class="${"font-serif text-4xl text-center"}">Open now!</h1>`}
	<div class="${"font-serif text-3xl text-center pt-5 align-middle leading-normal"}"><button class="${"bg-logoBlue-dark hover:bg-logoBlue-darkest text-white font-bold py-2 px-4 rounded align-middle"}"><i class="${"mi mi-location svelte-1w5xhqn"}"><span class="${"u-sr-only svelte-1w5xhqn"}">Location</span></i>
			Get directions
		</button>
		or
		<button class="${"bg-logoBlue-dark hover:bg-logoBlue-darkest text-white font-bold py-2 px-4 rounded align-middle"}"><i class="${"mi mi-call svelte-1w5xhqn"}"><span class="${"u-sr-only svelte-1w5xhqn"}">Call</span></i>
			call us
		</button></div>
</div>`;
    });
...
// .svelte-kit/output/server/chunks/app-fd18b859.js
...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-f410bad0.js",
      css: [assets + "/_app/assets/start-d5b4de3e.css"],
      js: [assets + "/_app/start-f410bad0.js", assets + "/_app/chunks/vendor-34ac3eba.js"]
    },
    fetched: void 0,
    floc: false,
...
${``}`;
    ...
    empty = () => ({});
    manifest = {
      assets: [{ "file": "favicon.png", "size": 1982, "type": "image/png" }, { "file": "images/logo.png", "size": 106398, "type": "image/png" }],
    ...
    module_lookup = {
      "src/routes/__layout.svelte": () => Promise.resolve().then(() => (init_layout_87e29705(), layout_87e29705_exports)),
      ".svelte-kit/build/components/error.svelte": () => Promise.resolve().then(() => (init_error_9773dc94(), error_9773dc94_exports)),
      "src/routes/index.svelte": () => Promise.resolve().then(() => (init_index_9b9b6a46(), index_9b9b6a46_exports))
    };
    metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-0156f23b.js", "css": ["assets/pages/__layout.svelte-25c66d5b.css"], "js": ["pages/__layout.svelte-0156f23b.js", "chunks/vendor-34ac3eba.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-b663066e.js", "css": [], "js": ["error.svelte-b663066e.js", "chunks/vendor-34ac3eba.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-409375eb.js", "css": ["assets/pages/index.svelte-3b384fab.css"], "js": ["pages/index.svelte-409375eb.js", "chunks/vendor-34ac3eba.js"], "styles": [] } };
  }
});
